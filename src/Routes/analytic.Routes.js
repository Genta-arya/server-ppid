...
import { GetAIInsightStatus, GetAllDataAnalytic, GetAnalytics, PostAnalytic } from "../Controller/analytic.controller.js";

const routerAnalytic = Router();

routerAnalytic.post("/analytic", PostAnalytic);
routerAnalytic.get("/analytic", GetAnalytics);
routerAnalytic.get("/analytic/all", GetAllDataAnalytic);
